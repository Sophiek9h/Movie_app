package com.twdc.movieapp.model;
...
import com.twdc.movieapp.serviceapi.MovieApiService;
import com.twdc.movieapp.serviceapi.RetrofitInstance;
...
public class MovieRepository {
    ...
    public MutableLiveData<List<Movie>> getMutableLiveData(){
        ...
        Call<Result> call = movieApiService.
                getPopularMovies(application.getApplicationContext().getString(R.string.apikey));
